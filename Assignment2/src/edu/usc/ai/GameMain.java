...
public class GameMain {
	...
	public static void main(String[] args) {
		Game game=new Game();
		for(int i=0;i<100;i++){
			game.readInput("D:\\Eclipse Workspace\\Assignment2\\testcases-5000\\INPUT\\"+i+".in", i);
			//game.display();
	        ...
	        File file2 = new File("D:\\Eclipse Workspace\\Assignment2\\testcases-5000\\OUTPUT\\"+i+".out");
